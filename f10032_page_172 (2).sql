...
--   Date and Time:   12:21 Saturday February 17, 2024
--   Exported By:     UMAR
--   Flashback:       0
...
,p_last_updated_by=>'UMAR.FAROOQ'
,p_last_upd_yyyymmddhh24miss=>'20240217122019'
);
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'ID:PLOT_ID:CUSTOMER_NAME:LS:PORTION:METER_TYPES:METER_REF_NO:PREV_READING:PAYABLE_ARREARS:CREATED_BY:CREATED_ON:ORG_ID:REMARKS:METER_INACTIVE:METER_STATUS:'
);
wwv_flow_api.create_page_plug(
